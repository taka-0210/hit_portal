...
$router->get('admin.grids', [AdminController::class, 'grids'], true, ['system_admin', 'store_admin']);
$router->post('admin.grids.move', [AdminController::class, 'moveGrid'], true, ['system_admin', 'store_admin']);
$router->post('admin.grids.resetStoreLayout', [AdminController::class, 'resetStoreLayout'], true, ['system_admin', 'store_admin']);
$router->get('admin.grids.create', [AdminController::class, 'createGrid'], true, ['system_admin', 'store_admin']);
$router->post('admin.grids.store', [AdminController::class, 'storeGrid'], true, ['system_admin', 'store_admin']);
$router->get('admin.grids.edit', [AdminController::class, 'editGrid'], true, ['system_admin', 'store_admin']);
$router->post('admin.grids.update', [AdminController::class, 'updateGrid'], true, ['system_admin', 'store_admin']);
$router->post('admin.grids.delete', [AdminController::class, 'deleteGrid'], true, ['system_admin', 'store_admin']);
